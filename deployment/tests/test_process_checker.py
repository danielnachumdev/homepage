...
class TestProcessChecker(BaseTest):
    ...
    def test_process_search_result_initialization(self):
        ...
        result = ProcessSearchResult(
            found=True, processes=[{"pid": 1234, "name": "test"}], total_count=1
        )
    ...
    def test_process_search_result_empty(self):
        ...
        result = ProcessSearchResult(found=False, processes=[], total_count=0)
    ...
    def test_is_backend_running_no_processes(self):
        ...
        result = self.run_async(
            is_backend_running(str(self.project_root), str(self.backend_dir))
        )
    ...
    def test_is_frontend_running_no_processes(self):
        ...
        result = self.run_async(
            is_frontend_running(str(self.project_root), str(self.frontend_dir))
        )
    ...
    def test_kill_processes_carefully_backend_process(self):
        ...
        self.assertTrue(
            logger.info.called or logger.warning.called or logger.error.called
        )
    ...
    def test_process_search_result_attributes(self):
        ...
        processes = [{"pid": 1, "name": "proc1"}, {"pid": 2, "name": "proc2"}]

        result = ProcessSearchResult(found=True, processes=processes, total_count=2)
