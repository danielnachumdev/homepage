...
from deployment.src.steps.native_backend_dependency_install_step import (
    NativeBackendDependencyInstallStep,
)
from deployment.src.steps.native_backend_deploy_step import NativeBackendDeployStep
from deployment.src.steps.native_frontend_dependency_install_step import (
...
from deployment.src.strategies.windows_native_deploy_strategy import (
...
class TestWindowsNativeDeployStrategy(BaseTest):
    ...
    def setUp(self):
        ...
        package_json = {
            "name": "test-frontend",
            "version": "1.0.0",
            "scripts": {"dev": "echo 'Frontend dev server started'"},
...
"""
    ...
    def test_strategy_initialization(self):
        ...
        self.assertIn(
            "Deploy homepage using native Windows processes", strategy.description
        )
    ...
    def test_get_port_info(self):
        ...
        strategy = WindowsNativeDeployStrategy(
            project_root=str(self.project_root), backend_port=8001, frontend_port=5174
        )
    ...
    def test_strategy_string_representation(self):
        ...
        strategy = WindowsNativeDeployStrategy(name="test-strategy")
    ...
    def test_strategy_with_none_directories(self):
        ...
        strategy = WindowsNativeDeployStrategy(
            project_root=None, backend_dir=None, frontend_dir=None
        )
    ...
    def test_strategy_port_validation(self):
        ...
        strategy2 = WindowsNativeDeployStrategy(backend_port=9000, frontend_port=3000)
