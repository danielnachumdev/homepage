...
class TestNativeFrontendDependencyInstallStep(BaseTest):
    ...
    def test_initialization_with_custom_frontend_dir(self):
        ...
        step = NativeFrontendDependencyInstallStep(
            project_root=str(self.project_root), frontend_dir=str(custom_frontend)
        )
    ...
    def test_validate_success(self):
        ...
        step = NativeFrontendDependencyInstallStep(
            project_root=str(self.project_root), frontend_dir=str(self.frontend_dir)
        )
    ...
    def test_validate_missing_frontend_dir(self):
        ...
        step = NativeFrontendDependencyInstallStep(
            project_root=str(self.project_root), frontend_dir="/non/existent/path"
        )
    ...
    def test_install_creates_node_modules(self):
        ...
        if result:  # Only check if installation succeeded
            ...
            self.assertTrue(
                node_modules.exists(),
                "node_modules should be created after installation",
            )
    ...
    def test_get_metadata_with_errors(self):
        ...
        step = NativeFrontendDependencyInstallStep(
            project_root="/non/existent/path", frontend_dir="/non/existent/frontend"
        )
