...
class BaseCommandTest(BaseTest):
    ...
    def create_timeout_command(
        self, timeout: float = 0.1, **kwargs: Any
    ) -> AsyncCommand:
    ...
    def create_gui_command(self, **kwargs: Any) -> AsyncCommand:
        ...
        return self.create_simple_command(
            ["notepad"], command_type=CommandType.GUI, **kwargs
        )
    ...
    def assert_command_success(
        self, result: CommandExecutionResult, expected_output: Optional[str] = None
    ) -> None:
    ...
    def assert_command_failure(
        self, result: CommandExecutionResult, expected_error: Optional[str] = None
    ) -> None:
    ...
    def mock_subprocess_success(
        self, stdout: str = "test output", stderr: str = "", returncode: int = 0
    ) -> patch:
